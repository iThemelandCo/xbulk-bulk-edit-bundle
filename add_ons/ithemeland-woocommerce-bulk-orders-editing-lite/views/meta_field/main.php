<div class="wobef-wrap">
    <div class="wobef-tab-middle-content">
        <div class="wobef-alert wobef-alert-default">
            <span><?php esc_html_e('You can add new orders meta fields in two ways: 1- Individually 2- Get from other order.', WBEBL_NAME); ?></span>
        </div>
        ...
        <div class="wobef-meta-fields-left">
            <div class="wobef-meta-fields-manual">
                <label for="wobef-meta-fields-manual_key_name"><?php esc_html_e('Manually', WBEBL_NAME); ?></label>
                <div class="wobef-meta-fields-manual-field">
                    <input type="text" id="wobef-meta-fields-manual_key_name" placeholder="<?php esc_html_e('Enter Meta Key ...', WBEBL_NAME); ?>">
            ...
            <div class="wobef-meta-fields-automatic">
                <label for="wobef-add-meta-fields-order-id"><?php esc_html_e('Automatically From Order', WBEBL_NAME); ?></label>
                <div class="wobef-meta-fields-automatic-field">
                    <input type="text" id="wobef-add-meta-fields-order-id" placeholder="<?php esc_html_e('Enter Order ID ...', WBEBL_NAME); ?>">
        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
            ...
            <div class="wobef-meta-fields-right" id="wobef-meta-fields-items">
                <p class="wobef-meta-fields-empty-text" <?php echo (!empty($meta_fields)) ? 'style="display:none";' : ''; ?>><?php esc_html_e("Please add your meta key manually", WBEBL_NAME); ?><br> <?php esc_html_e("OR", WBEBL_NAME); ?><br><?php esc_html_e("From another order", WBEBL_NAME); ?></p>
