<div class="wobef-meta-fields-right-item">
    ...
    <input type="text" name="meta_field_title[]" class="wobef-meta-fields-title" placeholder="<?php esc_html_e('Enter field title ...', WBEBL_NAME); ?>" value="<?php echo (isset($meta_field['title'])) ? esc_attr($meta_field['title']) : ''; ?>">
    ...
    <?php else : ?>
        <select class="wobef-meta-fields-type wobef-meta-fields-main-type" data-id="<?php echo (!empty($meta_field['key'])) ? esc_attr($meta_field['key']) : ''; ?>" name="meta_field_main_type[]" title="<?php esc_html_e('Select Type', WBEBL_NAME); ?>">
        ...
        <select class="wobef-meta-fields-type wobef-meta-fields-sub-type <?php echo (isset($meta_field['main_type']) && $meta_field['main_type'] != 'textinput') ? 'wobef-hide' : ''; ?>" data-id="<?php echo (!empty($meta_field['key'])) ? esc_attr($meta_field['key']) : ''; ?>" name="meta_field_sub_type[]" title="<?php esc_html_e('Select Type', WBEBL_NAME); ?>">
    ...
    <?php endif; ?>
    <button type="button" class="wobef-button wobef-button-flat wobef-meta-field-item-sortable-btn" title="<?php esc_html_e('Drag', WBEBL_NAME); ?>">
