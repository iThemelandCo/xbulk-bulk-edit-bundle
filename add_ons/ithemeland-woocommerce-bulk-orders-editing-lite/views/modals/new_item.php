        ...
        <div class="wobef-modal-box wobef-modal-box-sm">
            <div class="wobef-modal-content">
                ...
                <div class="wobef-modal-body">
                    <div class="wobef-wrap">
                        <div class="wobef-form-group">
                            ...
                            <input type="number" class="wobef-input-numeric-sm wobef-m0" id="wobef-new-item-count" value="1" placeholder="<?php esc_html_e('Number ...', WBEBL_NAME); ?>">
                        </div>
                ...
                <div class="wobef-modal-footer">
                    <button type="button" class="wobef-button wobef-button-blue" id="wobef-create-new-item"><?php esc_html_e('Create', WBEBL_NAME); ?></button>
                </div>
            </div>
        </div>
    </div>
