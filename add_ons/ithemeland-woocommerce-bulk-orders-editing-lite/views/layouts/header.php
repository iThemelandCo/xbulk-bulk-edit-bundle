<div id="wobef-main">
    ...
    <div id="wobef-header">
        <div class="wobef-plugin-title">
            ...
            <span class="wobef-plugin-description"><?php esc_html_e("Be professionals with managing data in the reliable and flexible way!", WBEBL_NAME); ?></span>
        </div>
        <div class="wobef-header-left">
            <div class="wobef-plugin-help">
                <span>
                    <a href="<?php echo (!empty($doc_link)) ? esc_url($doc_link) : '#'; ?>"><strong class="wobef-plugin-help-text"><?php esc_html_e('Need Help', WBEBL_NAME); ?></strong> <i class="lni-help"></i></a>
                </span>
            </div>
