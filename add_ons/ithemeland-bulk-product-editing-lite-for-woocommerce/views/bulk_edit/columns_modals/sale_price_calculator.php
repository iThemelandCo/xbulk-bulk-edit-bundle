                ...
                <div class="wcbef-modal-content">
                    ...
                    <div class="wcbef-modal-body">
                        <div class="wcbef-wrap">
                            <select id="wcbef-sale_price-calculator-operator-<?php echo esc_attr($product['id']); ?>" title="<?php esc_html_e('Select Operator', WBEBL_NAME); ?>">
                                <option value="+">+</option>
                                <option value="-">-</option>
                                <option value="rp-">rp-</option>
                            </select>
                            <input type="number" placeholder="<?php esc_html_e('Enter Value ...', WBEBL_NAME); ?>" id="wcbef-sale_price-calculator-value-<?php echo intval($product['id']); ?>" title="<?php esc_html_e('Value', WBEBL_NAME); ?>">
                            <select id="wcbef-sale_price-calculator-type-<?php echo esc_attr($product['id']); ?>" title="<?php esc_html_e('Select Type', WBEBL_NAME); ?>">
                                <option value="n">n</option>
                                <option value="%">%</option>
                            </select>
                            <select id="wcbef-sale_price-calculator-round-<?php echo esc_attr($product['id']); ?>" title="<?php esc_html_e('Rounding', WBEBL_NAME); ?>">
